    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $this->session->userdata('s_nombre'); ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>cpersona"><i class="fa fa-circle-o"></i> Registrar Persona</a></li>
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> Listar Personas</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
